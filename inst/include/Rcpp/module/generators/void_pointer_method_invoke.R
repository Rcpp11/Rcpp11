...
tmpl <- function(n) {  
    indices <- seq(0,n-1)
    sprintf( '
    template <typename Class, typename MemberFunctionType, %s>
    void void_pointer_method_invoke( traits::number_to_type<%d>, MemberFunctionType Method, Class* object, SEXP* args ){ 
        %s
        Method( object, %s ) ;
    }
    ', 
