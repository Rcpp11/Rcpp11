...
namespace stats {
    ...
    public:
        typedef SugarVectorExpression<RTYPE, NA, T> VEC_TYPE ;
...
inline stats::D0<RTYPE,NA,T> d##__NAME__(                                                    \
    const Rcpp::SugarVectorExpression<RTYPE,NA,T>& x, bool log = false                          \
) {                                                                                    \
    return stats::D0<RTYPE,NA,T>( __D__, x, log );                                           \
}                                                                                      \
template <int RTYPE, bool NA, typename T>                                                         \
inline stats::P0<RTYPE,NA,T> p##__NAME__(                                                    \
    const Rcpp::SugarVectorExpression<RTYPE,NA,T>& x, bool lower = true, bool log = false       \
) {                                                                                    \
...
inline stats::D1<RTYPE,NA,T> d##__NAME__(                                                    \
    const Rcpp::SugarVectorExpression<RTYPE,NA,T>& x, double p0, bool log = false                          \
) {                                                                                    \
    return stats::D1<RTYPE,NA,T>( __D__, x, p0, log );                                           \
}                                                                                      \
template <int RTYPE, bool NA, typename T>                                                         \
inline stats::P1<RTYPE,NA,T> p##__NAME__(                                                    \
    const Rcpp::SugarVectorExpression<RTYPE,NA,T>& x, double p0, bool lower = true, bool log = false       \
) {                                                                                    \
...
inline stats::D2<RTYPE,NA,T> d##__NAME__(                                                    \
    const Rcpp::SugarVectorExpression<RTYPE,NA,T>& x, double p0, double p1, bool log = false                          \
) {                                                                                    \
    return stats::D2<RTYPE,NA,T>( __D__, x, p0, p1, log );                                           \
}                                                                                      \
template <int RTYPE, bool NA, typename T>                                                         \
inline stats::P2<RTYPE,NA,T> p##__NAME__(                                                    \
    const Rcpp::SugarVectorExpression<RTYPE,NA,T>& x, double p0, double p1, bool lower = true, bool log = false       \
) {                                                                                    \
...
inline stats::D3<RTYPE,NA,T> d##__NAME__(                                                    \
    const Rcpp::SugarVectorExpression<RTYPE,NA,T>& x, double p0, double p1, double p2, bool log = false                          \
) {                                                                                    \
    return stats::D3<RTYPE,NA,T>( __D__, x, p0, p1, p2, log );                                           \
}                                                                                      \
template <int RTYPE, bool NA, typename T>                                                         \
inline stats::P3<RTYPE,NA,T> p##__NAME__(                                                    \
    const Rcpp::SugarVectorExpression<RTYPE,NA,T>& x, double p0, double p1, double p2, bool lower = true, bool log = false       \
) {                                                                                    \
